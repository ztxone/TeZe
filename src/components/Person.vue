...
const photoUrl = 'background-image: url(' + person.Photo + ');'
</script>

<template>
  <div class="min-w-[300px] w-auto h-[600px] bg-white flex flex-col rounded-xl shadow-xl shadow-gray-300/40 cursor-pointer">   
    ...
    <div class="flex flex-col h-[65%] justify-between p-4"> 
      ...
      <div class="attention">
        ...
        <div v-if="person.Attention !== null" class="relative flex h-4 bg-gray-200 rounded-xl overflow-hidden">
        ...
        <div v-else class="relative h-4 bg-gray-200 rounded-xl overflow-hidden"></div>
      </div>
